...
function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module["wasmTextFile"] || "pcsx_worker.wast";
    var wasmBinaryFile = Module["wasmBinaryFile"] || "pcsx_worker.wasm";
    var asmjsCodeFile = Module["asmjsCodeFile"] || "pcsx_worker.temp.asm.js";
...
var ASM_CONSTS = [(function($0, $1, $2, $3, $4, $5, $6) {
    ...
    {
        Module.HEAPU8.set(stdout_array.subarray($0, $2), $1)
    }
}), (function($0, $1) {
    {
        SendSound($0, $1)
...
STATICTOP = STATIC_BASE + 1114288;
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "pcsx_worker.js.mem" : null;
var STATIC_BUMP = 1114288;
...
staticSealed = true;
Module["wasmTableSize"] = 302;
Module["wasmMaxTableSize"] = 302;
...
var _ls = Module["_ls"] = (function() {
    return Module["asm"]["_ls"].apply(null, arguments)
});
...
var _one_iter = Module["_one_iter"] = (function() {
    return Module["asm"]["_one_iter"].apply(null, arguments)
});
...
var _pcsx_init = Module["_pcsx_init"] = (function() {
    return Module["asm"]["_pcsx_init"].apply(null, arguments)
});
